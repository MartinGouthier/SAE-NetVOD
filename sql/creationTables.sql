...
CREATE TABLE `user` (
  ...
  `favorite_genre` VARCHAR(256) DEFAULT NULL,
...
CREATE TABLE `episodeVisionne`(
    ...
    CONSTRAINT `FKepisodeVisionneEpisode` FOREIGN KEY (`id_episode`) REFERENCES `episode` (`id`),
    CONSTRAINT `FKepisodeVisionneUser` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
    )ENGINE=InnoDB DEFAULT CHARSET=utf8;
